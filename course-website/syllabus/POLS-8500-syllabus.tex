...
\subsection*{Day 15: Downstream Inference}

\textit{So you have your text-to-measure pipeline. Now what? How to make valid causal inferences using texts.}

\begin{itemize}
	\item Egami, Naoki, Christian J. Fong, Justin Grimmer, Margaret E. Roberts, and Brandon M. Stewart. “How to Make Causal Inferences Using Texts.” \textit{Science Advances} 8, no. 42 (2022).
	\item Egami, Naoki, Musashi Hinck, Brandon M. Stewart, and Hanying Wei (2026). ``Using Large Language Model Annotations for the Social Sciences: A General Framework of Using Predicted Variables in Downstream Analyses.'' Forthcoming in \textit{American Journal of Political Science}.
